#ifndef C_CORESLAM_HMI_H
#define C_CORESLAM_HMI_H
...
class C_CoreSlam_HMI : public QMainWindow
{
    Q_OBJECT

public:
    // Constructor
    explicit C_CoreSlam_HMI(QWidget * ptParent = nullptr, C_ScanseLidar * ptScanse = nullptr, C_Slamware * ptSlamware = nullptr);
    ...
    {
        return m_ptCoreSlam->GET_navMapScale__mmPerPixel();
    }
...
private:
    ...
    Ui::C_CoreSlam_HMI m_userInterface;
    ...
    C_CoreSlamRealAngle_8bppMap * m_ptCoreSlam = nullptr;
    QImage m_coreSlamMap;

    int m_count = 0;

    uint32_t m_tabConvSlamMapPixelToClearMapRgbPixel[256];
